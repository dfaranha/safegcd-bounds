...
let example =
  N.iter (Npos (XI (XO (XI (XI (XO (XI (XO (XO (XI (XO XH)))))))))))
    (processDivstep (Zpos (XI (XI (XO (XI (XI (XI (XI (XI (XO (XI (XI (XI (XI
      (XI (XI (XO (XI (XO (XO (XI (XI (XO (XI (XI (XO (XI (XO (XI (XO (XO (XO
      (XO (XO (XO (XO (XO (XI (XI (XI (XI (XO (XI (XI (XI (XO (XO (XI (XI (XI
      (XO (XI (XO (XO (XI (XI (XI (XI (XO (XO (XO (XI (XI (XI (XI (XI (XO (XI
      (XI (XI (XO (XI (XO (XO (XO (XO (XI (XI (XO (XO (XI (XO (XO (XI (XI (XI
      (XI (XO (XO (XI (XO (XO (XO (XO (XO (XO (XI (XO (XI (XO (XI (XI (XI (XO
      (XI (XI (XO (XO (XI (XI (XI (XO (XI (XI (XI (XO (XI (XO (XO (XI (XI (XO
      (XI (XI (XO (XO (XO (XO (XI (XI (XI (XI (XI (XI (XI (XO (XI (XI (XO (XO
      (XO (XI (XO (XO (XI (XO (XO (XI (XO (XI (XI (XO (XO (XO (XO (XI (XI (XO
      (XI (XO (XI (XI (XO (XO (XI (XO (XO (XO (XO (XI (XO (XI (XO (XO (XO (XI
      (XO (XO (XI (XI (XO (XO (XO (XO (XO (XO (XI (XO (XO (XI (XO (XI (XO (XO
      (XO (XO (XI (XI (XO (XI (XI (XO (XI (XO (XO (XO (XI (XO (XI (XO (XI (XI
      (XI (XO (XO (XO (XI (XI (XO (XO (XO (XO (XI (XO (XO (XO (XO (XI (XO (XO
      (XO (XI (XO (XI (XO (XO (XI (XO (XO (XI (XO (XI (XO (XI (XI (XI (XO (XO
      (XO (XO (XI (XI (XI (XI (XO (XI (XO (XI (XO (XO (XO (XI (XI (XI (XO (XO
      (XO (XO (XI (XI (XO (XO (XO (XO (XO (XO (XO (XI (XI (XI (XO (XO (XO (XI
      (XI (XO (XI (XI (XO (XO (XI (XO (XI (XI (XO (XO (XO (XO (XO (XI (XO (XI
      (XI (XI (XI (XO (XO (XI (XO (XI (XO (XO (XO (XI (XO (XI (XO (XI (XI (XI
      (XO (XI (XI (XI (XI (XI (XO (XO (XO (XI (XO (XI (XO (XI (XO (XO (XI (XO
      (XO (XO (XO (XO (XI (XO (XI (XI (XI (XI (XO (XI (XI (XO (XI (XI (XI (XI
      (XI (XI (XO (XO (XI (XO (XO (XI (XI (XO (XI (XI (XO (XI (XO (XO (XI (XO
      (XI (XI (XO (XO (XI (XO (XO (XO (XI (XO (XO (XI (XO (XO (XO (XI (XI (XI
      (XO (XO (XO (XO (XO (XO (XO (XO (XO (XI (XI (XO (XO (XO (XO (XO (XO (XO
      (XI (XO (XI (XO (XI (XO (XI (XI (XI (XO (XO (XI (XO (XI (XO (XO (XO (XO
      (XO (XI (XO (XI (XI (XI (XI (XI (XO (XI (XI (XO (XO (XI (XO (XO (XO (XO
      (XI (XI (XO (XO (XI (XO (XO (XO (XI (XO (XI (XO (XI (XI (XO (XI (XI (XO
      (XI (XO (XO (XO (XI (XO (XO (XI (XO (XI (XI (XO (XO (XI (XI (XO (XO (XO
      (XI (XO (XO (XI (XO (XI (XI (XI (XO (XI (XI (XI (XI (XI (XI (XI (XI (XO
      (XI (XO (XI (XO (XO (XI (XO (XO (XI (XI (XI (XO (XO (XO (XO (XI (XI (XI
      (XI (XO (XI (XO (XO (XI (XO (XO (XI (XI (XI (XI (XO (XI (XO (XI (XO (XI
      (XI (XO (XI (XO (XO (XO (XI (XI (XI (XO (XI (XO (XI (XO (XI (XO (XO (XO
      (XO (XO (XO (XO (XO (XI (XO (XI (XO (XI (XI (XI (XI (XO (XO (XI (XO (XI
      (XO (XI (XO
      XH))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
    state0
;;
