...
let example =
  N.iter (Npos (XO (XI (XI (XI (XO (XI (XI (XO (XI XH))))))))))
    (processDivstep (Zpos (XI (XI (XO (XI (XO (XI (XO (XI (XO (XI (XO (XI (XO
      (XI (XO (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI
      (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XO
      (XI (XI (XI (XI (XI (XI (XI (XI (XO (XO (XI (XI (XI (XO (XI (XI (XI (XI
      (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XO (XO (XI
      (XO (XI (XO (XI (XO (XO (XO (XI (XI (XO (XI (XO (XI (XI (XI (XI (XI (XI
      (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XI (XO (XI (XO (XI (XO (XI (XO
      (XI (XI (XI (XI (XO (XO (XO (XO (XO (XI (XO (XO (XI (XO (XO (XO (XI (XI
      (XO (XI (XI (XI (XI (XO (XO (XO (XO (XI (XI (XO (XI (XO (XI (XI (XO (XI
      (XI (XI (XI (XO (XO (XO (XO (XO (XI (XO (XI (XO (XI (XO (XO (XI (XO (XI
      (XI (XO (XO (XO (XO (XI (XI (XO (XO (XI (XI (XI (XO (XO (XI (XI (XO (XI
      (XI (XI (XI (XI (XI (XO (XI (XO (XI (XO (XO (XI (XO (XO (XO (XI (XO (XI
      (XO (XO (XO (XO (XI (XI (XI (XO (XO (XI (XI (XI (XI (XO (XO (XI (XO (XO
      (XO (XO (XI (XI (XI (XO (XI (XO (XO (XI (XO (XI (XI (XI (XO (XI (XI (XI
      (XO (XO (XO (XI (XO (XO (XI (XI (XO (XI (XI (XI (XO (XI (XO (XI (XI (XO
      (XO (XI (XI (XO (XI (XO (XI (XI (XI (XO (XI (XO (XO (XI (XO (XI (XI (XO
      (XO (XO (XO (XI (XO (XO (XI (XI (XO (XI (XI (XO (XI (XI (XI (XI (XO (XO
      (XI (XO (XI (XI (XI (XO (XI (XI (XO (XO (XO (XI (XI (XO (XI (XO (XO (XI
      (XO (XO (XI (XO (XI (XI (XO (XO (XI (XO (XI (XI (XO (XO (XI (XI (XI (XI
      (XI (XI (XI (XI (XI (XI (XO (XI (XO (XO (XI (XI (XI (XO (XO (XO (XI (XO
      (XI (XO (XI (XI (XI (XI (XO (XO (XO (XI (XO (XO (XO (XI (XO (XO (XO (XO
      (XO (XO (XO (XO (XI (XO (XI
      XH))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
    state0
;;
